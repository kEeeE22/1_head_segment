...
CUSTOM_ICON_MAP = {
    ...
    "SaunaBench": None,
    "Fireplace": None,
    "FireplaceCorner": None,
    "FireplaceRound": None,
    "PlaceForFireplace": None,
    "PlaceForFireplaceCorner": None,
    "PlaceForFireplaceRound": None,
    "Bathtub": None,
    "BathtubRound": None,
    "Chimney": None,
    "Misc": None,
    ...
    "Jacuzzi": None,
    "WashingMachine": None,
    "IntegratedStove": None,
    "Dishwasher": None,
    "GeneralAppliance": None,
    "SaunaStove": None,
    "Cooking": None,
    "Dryer": None,
    "Refrigerator": None,
    "Sofa": None,
    "FixedFurniture": None,  # This was causing the warning
}
